#!/usr/bin/env python3
"""
Script para ejecutar solo el proceso web de extracción y publicación
...
def print_header():
    ...
    print("🎓 BOT DE CURSOS UDEMY - SOLO WEB")
    print("=" * 60)
    print("Este script ejecutará SOLO el proceso web:")
    print("1. Extraer cursos con capturas de pantalla")
    print("2. Crear página web para GitHub Pages")
    print("3. Configurar automatización web")
    print("4. Publicar en GitHub Pages")
    print("📱 SIN envío a WhatsApp")
    print("=" * 60)
...
def run_web_publication():
    """Ejecutar publicación web en GitHub"""
    print("\n🚀 PASO 2: Publicando en GitHub Pages...")
    print("📱 SOLO WEB - Sin WhatsApp")
    
    try:
        result = subprocess.run([sys.executable, "web_publisher.py"], 
                              capture_output=True, text=True)
        
        if result.returncode == 0:
            print("✅ Publicación web completada exitosamente")
            if result.stdout:
                print("📄 Salida:")
                print(result.stdout)
            return True
        else:
            print("❌ Error en la publicación web")
            if result.stderr:
                print("💥 Error:")
                print(result.stderr)
            return False
    except Exception as e:
        print(f"❌ Error ejecutando publicación web: {e}")
        return False
...
def show_results():
    ...
    files_to_check = [
        ...
        (".github/workflows/auto-extract-web.yml", "Workflow de automatización web")
    ]
...
def show_next_steps():
    ...
    print("7. 📱 SOLO WEB - No se enviará a WhatsApp")
    print()
    ...
    print("- 📱 Este sistema NO envía a WhatsApp")
...
def main():
    ...
    # Ejecutar publicación web
    if not run_web_publication():
        print("\n❌ Error en la publicación web")
        return False
...
if __name__ == "__main__":
    try:
        success = main()
        if success:
            print("\n✅ Todo el proceso web se completó exitosamente")
            print("📱 Sistema configurado solo para GitHub Pages")
        else:
            print("\n💥 El proceso web falló")
            sys.exit(1)
